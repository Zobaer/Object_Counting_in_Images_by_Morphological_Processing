clc; clear; close all;f=14;I = im2double(imread('cells.bmp'));s = size(I);
...
for iii = 1:num
    ...
    for i=1:length(sortind)
        ...
        if (compnew <= complast+70) %if there's no significant improvement
...
% imwrite(Iglobal,'detected_disc.bmp');
